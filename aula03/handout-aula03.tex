...
\setaula{Aula 3 — Avaliação de política sem modelo}
\setprof{Prof. Marcelo Keese Albertini}

%% Macros locais (portadas do antigo handout1colRL; corpo da aula intacto)
\usepackage{tabularx}
...
\capa{Aula 3: Avaliação de política sem modelo}
     {Como estimar $\Vpi$ sem conhecer $P$ nem $\rec$ \textbullet\ Monte Carlo, Diferença Temporal e Equivalência de certeza}
     {Prof. Marcelo Keese Albertini}
...
%% ---------------------------------------------------------------
\section{2. Diferença temporal — TD(0)}
...
%% ---------------------------------------------------------------
\section{3. Equivalência de certeza}
...
%% ---------------------------------------------------------------
\section{Exemplo numérico — \emph{Mars Rover}}
...
\vspace{0.3em}
\section{Vocabulário para ler a literatura em inglês}
