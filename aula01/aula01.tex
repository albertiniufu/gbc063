...
\begin{frame}[shrink]{Ementa oficial: o curso é de Inteligência Artificial}
  ...
  \begin{alertabox}
    A disciplina é de Inteligência Artificial: a ficha oficial pede
    também os fundamentos simbólicos. Esta aula dá o panorama e as
    pontes; o curso mergulha fundo no RL.
  \end{alertabox}
\end{frame}
